...
// StarRocksParserListener is a complete listener for a parse tree produced by StarRocksParser.
type StarRocksParserListener interface {
	...
	// EnterDisableBaselinePlanStatement is called when entering the disableBaselinePlanStatement production.
	EnterDisableBaselinePlanStatement(c *DisableBaselinePlanStatementContext)

	// EnterEnableBaselinePlanStatement is called when entering the enableBaselinePlanStatement production.
	EnterEnableBaselinePlanStatement(c *EnableBaselinePlanStatementContext)
	...
	// ExitDisableBaselinePlanStatement is called when exiting the disableBaselinePlanStatement production.
	ExitDisableBaselinePlanStatement(c *DisableBaselinePlanStatementContext)

	// ExitEnableBaselinePlanStatement is called when exiting the enableBaselinePlanStatement production.
	ExitEnableBaselinePlanStatement(c *EnableBaselinePlanStatementContext)
