...
type StarRocksParserVisitor interface {
	...
	VisitDisableBaselinePlanStatement(ctx *DisableBaselinePlanStatementContext) interface{}

	// Visit a parse tree produced by StarRocksParser#enableBaselinePlanStatement.
	VisitEnableBaselinePlanStatement(ctx *EnableBaselinePlanStatementContext) interface{}
