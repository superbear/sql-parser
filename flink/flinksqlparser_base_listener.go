...
func (s *BaseFlinkSqlParserListener) EnterProgram(ctx *ProgramContext) {}

// ExitProgram is called when production program is exited.
func (s *BaseFlinkSqlParserListener) ExitProgram(ctx *ProgramContext) {}
...
// EnterValueDefinition is called when production valueDefinition is entered.
func (s *BaseFlinkSqlParserListener) EnterValueDefinition(ctx *ValueDefinitionContext) {}

// ExitValueDefinition is called when production valueDefinition is exited.
func (s *BaseFlinkSqlParserListener) ExitValueDefinition(ctx *ValueDefinitionContext) {}
...
func (s *BaseFlinkSqlParserListener) EnterSubstring(ctx *SubstringContext) {}

// ExitSubstring is called when production substring is exited.
func (s *BaseFlinkSqlParserListener) ExitSubstring(ctx *SubstringContext) {}
