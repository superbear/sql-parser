...
type FlinkSqlParserListener interface {
	...
	// EnterValueDefinition is called when entering the valueDefinition production.
	EnterValueDefinition(c *ValueDefinitionContext)
	...
	// ExitValueDefinition is called when exiting the valueDefinition production.
	ExitValueDefinition(c *ValueDefinitionContext)
